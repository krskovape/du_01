        ...
        Column {
            ...
            ComboBox {
                ...
                onActivated: {
                    ...
                    filtrModel.remove_from_seznam(filtrModel.kraj_filtr)
                    filtrModel.add_to_seznam(filtrModel.kraj_filtr, krajBox.currentText)
                    if (currentIndex == 0)
                        okresBox.model = ["všechny"]
                        filtrModel.add_to_seznam(filtrModel.okres_filtr, "všechny")
                    if (currentIndex == 1)
            ...
            ComboBox {
                ...
                model: ["všechny"]
                onActivated: {
                    console.log("okres: "+currentText)
                    filtrModel.remove_from_seznam(filtrModel.okres_filtr)
                    filtrModel.add_to_seznam(filtrModel.okres_filtr, okresBox.currentText)
                }
                /*Binding {
                    target: filtrModel
